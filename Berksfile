...
cookbook "s3fs-fuse", git: 'git://github.com/octoblu/cookbook-s3fs-fuse.git'
cookbook "application_python", git: 'git://github.com/octoblu/application_python.git'
cookbook "application_nginx", git: 'git://github.com/octoblu/application_nginx.git'
...
cookbook "nodered-docker", git: 'git://github.com/octoblu/nodered-docker-cookbook.git'
